...
export function TypeRacer() {
  ...
  const { players, currentPlayer, sentence, updatePlayer, requestNewSentence } = useSocket();
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="mt-5 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleNewSentence} className="px-5 py-2.5 text-base bg-blue-500 text-white border-none rounded-md cursor-pointer font-bold">New Sentence</button>
          </div>
        </div>
        </div>
